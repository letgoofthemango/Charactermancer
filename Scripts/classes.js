class App {
    ...
    static update() {
        ...
        for (let i = 0; i < skills.length; i++) {
            ...
            document.getElementById("skillsID" + i).textContent = this.getNumber(skills[i].mod);
        }
        //update stats loop
        for (let i = 0; i < abilityScores.length; i++) {
            totals[i].textContent = abilityScores[i].value;
            mods[i].textContent = this.getNumber(abilityScores[i].mod());
        }
        ...
        initiativeNode.textContent = this.getNumber(initiativeMod);
    }
...
class Cleric extends Character {
    static clericFeaturesByLevel = [`<h1 class="text-center">Cleric<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
<h3>Divine Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse"
    ...
    static deathDomain = `<h4 class="text-center">Death Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#deathCollapse" aria-expanded="true" aria-controls="deathCollapse">[-]</button></span></h4>
<div class="collapse show" id="deathCollapse">
    ...
    static forgeDomain = `<h4 class="text-center">Forge Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#forgeCollapse" aria-expanded="true" aria-controls="forgeCollapse">[-]</button></span></h4>
<div class="collapse show" id="forgeCollapse">
    ...
    static graveDomain = `<h4 class="text-center">Grave Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static knowledgeDomain = `<h4 class="text-center">Knowledge Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static lifeDomain = `<h4 class="text-center">Life Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static lightDomain = `<h4 class="text-center">Light Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static natureDomain = `        <h4 class="text-center">Nature Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static orderDomain = `<h4 class="text-center">Order Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static peaceDomain = `<h4 class="text-center">Peace Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static protectionDomain = `<h4 class="text-center">Protection Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static tempestDomain = `<h4 class="text-center">Tempest Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static trickeryDomain = `<h4 class="text-center">Trickery Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
    ...
    static twilightDomain = `<h4 class="text-center">Twilight Domain<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#domainCollapse" aria-expanded="true" aria-controls="domainCollapse">[-]</button></span></h4>
<div class="collapse show" id="domainCollapse">
...
class Druid extends Character {
    static druidFeaturesByLevel = [`<h1 class="text-center">Druid<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
class Fighter extends Character {
    static fighterFeaturesByLevel = [`<h1 class="text-center">Fighter<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 4`, `<p>fighter 5`, `<p>fighter 6`, `<p>fighter 7`, `<p>fighter 8`, `<p>fighter 3`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 2`, `<p>fighter 3`, `<p>fighter 2`];
    static archery = `    <h6 class="text-center"><b>Archery</b></h6>
<p>You gain a +2 bonus to attack rolls you make with ranged weapons.</p>`;
    static blindFighting = `<h6 class="text-center"><b>Blind Fighting</b></h6>
<p>You have blindsight with a range of 10 feet. Within that range, you can effectively see anything that isn't behind total cover, even if you're blinded or in darkness. Moreover, you can see an invisible creature within that range, unless
    ...
    static closeQuartersShooter = `<h6 class="text-center"><b>Close Quarters Shooter</b></h6>
<p>When making a ranged attack while you are within 5 feet of a hostile creature, you do not have disadvantage on the attack roll. Your ranged attacks ignore half cover and three-quarters cover against targets within 30 feet of you. You have
    ...
    static defense = `<h6 class="text-center"><b>Defense</b></h6>
<p>While you are wearing armor, you gain a +1 bonus to AC.</p>`;
    static dueling = `<h6 class="text-center"><b>Dueling</b></h6>
<p>When you are wielding a melee weapon in one hand and no other weapons, you gain a +2 bonus to damage rolls with that weapon.</p>`;
    static greatWeaponFighting = `<h6 class="text-center"><b>Great Weapon Fighting</b></h6>
<p>When you roll a 1 or 2 on a damage die for an attack you make with a melee weapon that you are wielding with two hands, you can reroll the die and must use the new roll, even if the new roll is a 1 or a 2. The weapon must have the two-handed
    ...
    static interception = `<h6 class="text-center"><b>Interception</b></h6>
<p>When a creature you can see hits a target, other than you, within 5 feet of you with an attack, you can use your reaction to reduce the damage the target takes by 1d10 + your proficiency bonus (to a minimum of 0 damage). You must be wielding
    ...
    static mariner = `<h6 class="text-center"><b>Mariner</b></h6>
<p>As long as you are not wearing heavy armor or using a shield, you have a swimming speed and a climbing speed equal to your normal speed, and you gain a +1 bonus to AC.</p>`;
    static protection = `<h6 class="text-center"><b>Protection</b></h6>
<p>When a creature you can see attacks a target other than you that is within 5 feet of you, you can use your reaction to impose disadvantage on the attack roll. You must be wielding a shield.</p>`;
    static superiorTechnique = `<h6 class="text-center"><b>Superior Technique</b></h6>
...
<p>You gain one superiority die, which is a d6 (this die is added to any superiority dice you have from another source). This die is used to fuel your maneuvers. A superiority die is expended when you use it. You regain your expended superiority
    ...
    static thrownWeaponFighting = `<h6 class="text-center"><b>Thrown Weapon Fighting</b></h6>
<p>You can draw a weapon that has the thrown property as part of the attack you make with the weapon. In addition, when you hit with a ranged attack using a thrown weapon, you gain a +2 bonus to the damage roll.</p>`;
    static tunnelFighter = `<h6 class="text-center"><b>Tunnel Fighter</b></h6>
<p>As a bonus action, you can enter a defensive stance that lasts until the start of your next turn. While in your defensive stance, you can make opportunity attacks without using your reaction, and you can use your reaction to make a melee
    ...
    static twoWeaponFighting = `<h6 class="text-center"><b>Two-Weapon Fighting</b></h6>
...
class Mystic extends Character {
    static mysticFeaturesByLevel = [`<h1 class="text-center">Mystic<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
class Ranger extends Character {
    static rangerFeaturesByLevel = [`<h1 class="text-center">Ranger<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
class Sorcerer extends Character {
    static sorcererFeaturesByLevel = [`<h1 class="text-center">Sorcerer<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#collapseIntro" aria-expanded="true"
aria-controls="collapseIntro">[-]</button></span></h1>
...
<p>Whenever you finish a long rest, you can replace one spell you learned from this Spellcasting feature with another spell from the sorcerer spell list. The new spell must be the same level as the spell you replace.</p>
    ...
    static aberrant = `<h4 class="text-center">Aberrant Mind<span class="ml-2"><button class="collapseButton" type="button" data-toggle="collapse" data-target="#Origin" aria-expanded="true" aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
    ...
    static clockwork = `<h4 class="text-center">Clockwork Soul<span class="ml-2"><button class="collapseButton" type="button"
...
<p>Once you use this action, you can't use it again until you finish a long rest, unless you spend 7 sorcery points to use it again.</p>
    ...
    static divine = `<h4 class="text-center">Divine Soul<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#Origin" aria-expanded="true"
aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
...
<li>If you use your Phoenix Spark, that feature deals an extra 20 fire damage to each creature.</li>
    ...
    static sea = `<h4 class="text-center">Sea Sorcery<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#Origin" aria-expanded="true"
aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
...
<li>You have resistance to bludgeoning, piercing, and slashing damage.</li>
    ...
    static shadow = `<h4 class="text-center">Shadow Magic<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#Origin" aria-expanded="true"
aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
...
<p>You remain in this form for 1 minute. It ends early if you are incapacitated, if you die, or if you dismiss it as a bonus action.</p>
    ...
    static storm = `<h4 class="text-center">Storm Sorcery<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#Origin" aria-expanded="true"
aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
...
<p>You also gain a magical flying speed of 60 feet. As an action, you can reduce your flying speed to 30 feet for 1 hour and choose a number of creatures within 30 feet of you equal to 3 + your Charisma modifier. The chosen creatures gain a magical flying speed of 30 feet for 1 hour. Once you reduce your flying speed in this way, you can't do so again until you finish a short or long rest.</p>
    ...
    static wild = `<h4 class="text-center">Wild Magic<span class="ml-2"><button class="collapseButton" type="button"
data-toggle="collapse" data-target="#Origin" aria-expanded="true"
aria-controls="Origin">[-]</button></span></h4>
<div class="collapse show" id="Origin">
