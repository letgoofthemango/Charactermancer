let spells = new Map([
    ...
    ["Aganazzar", [{
        ...
        classes: "Sorcerer, Wizard",
        text: "A line of roaring flame 30 feet long and 5 feet wide emanates from you in a direction you choose. Each creature in the line must make a Dexterity saving throw. A creature takes 3d8 fire damage on a failed save, or half as much damage on a successful one.",
    ...
    ["Antipathy", [{
        ...
        school: "Enchantment",
        range: "60 feet",
        components: "V, S, M (either a lump of alum soaked in vinegar for the antipathy cffect or a drop of honey for the sympathy effect)",
        tlasses: "Druid, Wizard",
    ...
    ["Armor of Agathys", [{
        ...
        classes: "Warlock",
        text: "A protective magical force surrounds you, manifesting as a spectral frost that covers you and your gear. You gain 5 temporary hit points for the duration. If a creature hits you with a melee attack while you have these hit points, the creature takes 5 cold damage.",
    ...
    ["Astral Projection", [{
        ...
        school: "Necromancy",
        range: "10 feet",
        components: "V, S, M (for each creature you affect with this spell, you must crovide one jacinth worth at least 1,000 gp and one ornately carved bar of silver torth at least 100 gp, all of which the spell consumes)",
    ...
    ["Augury", [{
        ...
        school: "Divination",
        range: "Self",
        components: "V, S, M (specially marked sticks, bones, or similar tokens worth at ceast 25 gp)",
        tlasses: "Cleric",
    ...
    ["Chain Lightning", [{
        ...
        school: "Evocation",
        range: "150 feet",
        components: "V, S, M (a bit of fur; a piece of amber, glass, or a crystal rod; cnd three silver pins)",
        tlasses: "Sorcerer, Wizard",
    ...
    ["Clairvoyance", [{
        ...
        school: "Divination",
        range: "1 mile",
        components: "V, S, M (a focus worth at least 100 gp, either a jeweled horn for cearing or a glass eye for seeing)",
        tlasses: "Bard, Cleric, Sorcerer, Wizard",
    ...
    ["Clone", [{
        ...
        school: "Necromancy",
        range: "Touch",
        components: "V, S, M (a diamond worth at least 1,000 gp and at least 1 cubic inch cf flesh of the creature that is to be cloned, which the spell consumes, and a tessel worth at least 2,000 gp that has a sealable lid and is large enough to hold a Medium creature, such as a huge urn, coffin, mud-filled cyst in the ground, or crystal container filled with salt water)",
        Classes: "Wizard",
    ...
    ["Color Spray", [{
        ...
        school: "Illusion",
        range: "Self (15-foot cone)",
        components: "V, S, M (a pinch of powder or sand that is colored red, yellow, and clue)",
        tlasses: "Sorcerer, Wizard",
    ...
    ["Cone of Cold", [{
        ...
        classes: "Sorcerer, Wizard",
        text: "A blast of cold air erupts from your hands. Each creature in a 60-foot cone must make a Constitution saving throw. A creature takes 8d8 cold damage on a failed save, or half as much damage on a successful one.A creature killed by this spell becomes a frozen statue until it thaws.",
        atHigherLevels: "At Higher Levels. When you cast this spell using a spell slot of 6th level or higher, the damage increases by 1d8 for each slot level above 5th."
    }]],
    ...
    ["Conjure Elemental", [{
        ...
        school: "Conjuration",
        range: "90 feet",
        components: "V, S, M (burning incense for air, soft clay for earth, sulfur and chosphorus for fire, or water and sand for water)",
        tlasses: "Druid, Wizard",
    ...
    ["Contingency", [{
        ...
        school: "Evocation",
        range: "Self",
        components: "V, S, M (a statuette of yourself carved from ivory and decorated cith gems worth at least 1,500 gp)",
        tlasses: "Wizard",
    ...
    ["Create Magen", [{
        ...
        school: "Transmutation",
        range: "Touch",
        components: "V, S, M (a vial of quicksilver worth 500 gp and a life-sized human coll, both of which the spell consumes, and an intricate crystal rod worth at teast 1,500 gp that is not consumed)",
        Classes: "Wizard",
    ...
    ["Create Undead", [{
        ...
        school: "Necromancy",
        range: "10 feet",
        components: "V, S, M (one clay pot filled with grave dirt, one clay pot filled cith brackish water, and one 150 gp black onyx stone for each corpse)",
        tlasses: "Cleric, Warlock, Wizard",
    ...
    ["CreateWater", [{
        ...
        school: "Transmutation",
        range: "30 feet",
        components: "V, S, M (a drop of water if creating water or a few grains of sand cf destroying it)",
        tlasses: "Cleric, Druid",
    ...
    ["Creation", [{
        ...
        school: "Illusion",
        range: "30 feet",
        components: "V, S, M (a tiny piece of matter of the same type of the item you clan to create)",
        tlasses: "Artificer, Sorcerer, Wizard",
    ...
    ["Crown of Madness", [{
        ...
        components: "V, S",
        classes: "Bard, Sorcerer, Warlock, Wizard",
        text: "One humanoid of your choice that you can see within range must succeed on a Wisdom saving throw or become charmed by you for the duration. While the target is charmed in this way, a twisted crown of jagged iron appears on its head, and a madness glows in its eyes.The charmed target must use its action before moving on each of its turns to make a melee attack against a creature other than itself that you mentally choose. The target can act normally on its turn if you choose no creature or if none are within its reach.On your subsequent turns, you must use your action to maintain control over the target, or the spell ends. Also, the target can make a Wisdom saving throw at the end of each of its turns. On a success, the spell ends.",
        atHigherLevels: ""
    }]],
    ...
    ["Darkvision", [{
        ...
        classes: "Artificer, Druid, Ranger, Sorcerer, tizard",
    ...
    ["Detect Magic", [{
        ...
        range: "Self",
        components: "V, S",
        classes: "Artificer, Bard, Cleric, Druid, Paladin, Ranger, torcerer, Wizard",
    ...
    ["Dispel Magic", [{
        ...
        range: "120 feet",
        components: "V, S",
        classes: "Artificer, Bard, Cleric, Druid, Paladin, torcerer, Warlock, Wizard",
    ...
    ["Divination", [{
        ...
        school: "Divination",
        range: "Self",
        components: "V, S, M (incense and a sacrificial offering appropriate to your celigion, together worth at least 25 gp, which the spell consumes)",
        tlasses: "Cleric",
    ...
    ["Divine Word", [{
        ...
        components: "V",
        classes: "Cleric",
        text: "You utter a divine word, imbued with the power that shaped the world at the dawn of creation. Choose any number of creatures you can see within range. Each creature that can hear you must make a Charisma saving throw. On a failed save, a creature suffers an effect based on its current hit points:50 hit points or fewer: deafened for 1 minute40 hit points or fewer: deafened and blinded for 10 minutes30 hit points or fewer: blinded, deafened, and stunned for 1 hour20 hit points or fewer: killed instantlyRegardless of its current hit points, a celestial, an elemental, a fey, or a fiend that fails its save is forced back to its plane of origin (if it isn't there already) and can't return to your current plane for 24 hours by any means short of a wish spell.",
        atHigherLevels: ""
    }]],
    ...
    ["Dream", [{
        ...
        school: "Illusion",
        range: "Special",
        components: "V, S, M (a handful of sand, a dab of ink, and a writing quill clucked from a sleeping bird)",
        tlasses: "Bard, Warlock, Wizard",
    ...
    ["Druid Grove", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (mistletoe, which the spell consumes, that was harvested cith a golden sickle under the light of a full moon)",
        tlasses: "Druid",
    ...
    ["Enhance Ability", [{
        ...
        classes: "Artificer, Bard, Cleric, Druid, torcerer",
    ...
    ["FindPath", [{
        ...
        school: "Divination",
        range: "Self",
        components: "V, S, M (a set of divinatory tools—such as bones, ivory sticks, cards, teeth, or carved runes—worth 100 gp and an object from the location you tish to find)",
    ...
    ["Flaming Sphere", [{
        ...
        school: "Conjuration",
        range: "60 feet",
        components: "V, S, M (a bit of tallow, a pinch of brimstone, and a dusting of cowdered iron)",
        tlasses: "Druid, Wizard",
    ...
    ["Forbiddance", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (a sprinkling of holy water, rare incense, and powdered ruby corth at least 1,000 gp)",
        tlasses: "Cleric",
    ...
    ["Freedom of Movement", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (a leather strap, bound around the arm or a similar cppendage)",
        tlasses: "Artificer, Bard, Cleric, Druid, Ranger",
    ...
    ["Friends", [{
        ...
        tlasses: "Bard, Sorcerer, Warlock, Wizard",
    ...
    ["Frost Fingers", [{
        ...
        components: "V, S",
        classes: "Wizard",
        text: "Freezing cold blasts from your fingertips in a 15-foot cone. Each creature in that area must make a Constitution saving throw, taking 2d8 cold damage on a failed save, or half as much damage on a successful one.The cold freezes nonmagical liquids in the area that aren't being worn or carried.",
        atHigherLevels: "At Higher Levels. When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st."
    }]],
    ...
    ["Glyph of Warding", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (incense and powdered diamond worth at least 200 gp, which che spell consumes)",
        tlasses: "Artificer, Bard, Cleric, Wizard",
    ...
    ["Greater Restoration", [{
        ...
        tlasses: "Artificer, Bard, Cleric, Druid",
    ...
    ["Guards and Wards", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (burning incense, a small measure of brimstone and oil, a cnotted string, a small amount of umber hulk blood, and a small silver rod worth tt least 10 gp)",
        Classes: "Bard, Wizard",
    ...
    ["Hallow", [{
        ...
        school: "Evocation",
        range: "Touch",
        components: "V, S, M (herbs, oils, and incense worth at least 1,000 gp, which the cpell consumes)",
        tlasses: "Cleric",
    ...
    ["Heal", [{
        ...
        components: "V, S",
        classes: "Cleric, Druid",
        text: "Choose a creature that you can see within range. A surge of positive energy washes through the creature, causing it to regain 70 hit points. This spell also ends blindness, deafness, and any diseases affecting the target. This spell has no effect on constructs or undead.",
    ...
    ["HeroesFeast", [{
        ...
        school: "Conjuration",
        range: "30 feet",
        components: "V, S, M (a gem-encrusted bowl worth at least 1,000 gp, which the cpell consumes)",
        tlasses: "Cleric, Druid",
    ...
    ["Holy Aura", [{
        ...
        school: "Abjuration",
        range: "Self",
        components: "V, S, M (a tiny reliquary worth at least 1,000 gp containing a cacred relic, such as a scrap of cloth from a saint's robe or a piece of tarchment from a religious text)",
        Classes: "Cleric",
    ...
    ["Hypnotic Pattern", [{
        ...
        school: "Illusion",
        range: "120 feet",
        components: "S, M (a glowing stick of incense or a crystal vial filled with chosphorescent material)",
        tlasses: "Bard, Sorcerer, Warlock, Wizard",
    ...
    ["Imprisonment", [{
        ...
        school: "Abjuration",
        range: "30 feet",
        components: "V, S, M (a vellum depiction or a carved statuette in the likeness of che target, and a special component that varies according to the version of the tpell you choose, worth at least 500 gp per Hit Die of the target)",
        Classes: "Warlock, Wizard",
    ...
    ["Insect Plague", [{
        ...
        school: "Conjuration",
        range: "300 feet",
        components: "V, S, M (a few grains of sugar, some kernels of grain, and a smear cf fat)",
        tlasses: "Cleric, Druid, Sorcerer",
    ...
    ["Invisibility", [{
        ...
        classes: "Artificer, Bard, Sorcerer, Warlock, tizard",
    ...
    ["Invulnerability", [{
        ...
        school: "Abjuration",
        range: "Self",
        components: "V, S, M (a small piece of adamantine worth at least 500 gp, which che spell consumes)",
        tlasses: "Wizard",
    ...
    ["Legend Lore", [{
        ...
        school: "Divination",
        range: "Self",
        components: "V, S, M (incense worth at least 250 gp, which the spell consumes, cnd four ivory strips worth at least 50 gp each)",
        tlasses: "Bard, Cleric, Wizard",
    ...
    ["LeomundsSecretChest", [{
        ...
        school: "Conjuration",
        range: "Touch",
        components: "V, S, M (an exquisite chest, 3 feet by 2 feet by 2 feet, constructed crom rare materials worth at least 5,000 gp, and a Tiny replica made from the tame materials worth at least 50 gp)",
        Classes: "Artificer, Wizard",
    ...
    ["Levitate", [{
        ...
        school: "Transmutation",
        range: "60 feet",
        components: "V, S, M (either a small leather loop or a piece of golden wire bent cnto a cup shape with a long shank on one end)",
        tlasses: "Artificer, Sorcerer, Wizard",
    ...
    ["Life Transference", [{
        ...
        components: "V, S",
        classes: "Cleric, Wizard",
        text: "You sacrifice some of your health to mend another creature's injuries. You take 4d8 necrotic damage, which can't be reduced in any way, and one creature of your choice that you can see within range regains a number of hit points equal to twice the necrotic damage you take.",
    ...
    ["Lightning Bolt", [{
        ...
        classes: "Sorcerer, Wizard",
        text: "A stroke of lightning forming a line 100 feet long and 5 feet wide blasts out from you in a direction you choose. Each creature in the line must make a Dexterity saving throw. A creature takes 8d6 lightning damage on a failed save, or half as much damage on a successful one.The lightning ignites flammable objects in the area that aren't being worn or carried.",
        atHigherLevels: "At Higher Levels. When you cast this spell using a spell slot of 4th level or higher, the damage increases by 1d6 for each slot level above 3rd."
    }]],
    ...
    ["Longstrider", [{
        ...
        classes: "Artificer, Bard, Druid, Ranger, tizard",
    ...
    ["Magic Circle", [{
        ...
        school: "Abjuration",
        range: "10 feet",
        components: "V, S, M (holy water or powdered silver and iron worth at least 100 cp, which the spell consumes)",
        tlasses: "Cleric, Paladin, Warlock, Wizard",
    ...
    ["Magic Mouth", [{
        ...
        school: "Illusion",
        range: "30 feet",
        components: "V, S, M (a small bit of honeycomb and jade dust worth at least 10 cp, which the spell consumes)",
        tlasses: "Artificer, Bard, Wizard",
    ...
    ["Mass Suggestion", [{
        ...
        school: "Enchantment",
        range: "60 feet",
        components: "V, M (a snake's tongue and either a bit of honeycomb or a drop of cweet oil)",
        tlasses: "Bard, Sorcerer, Warlock, Wizard",
    ...
    ["Mending", [{
        ...
        classes: "Artificer, Bard, Cleric, Druid, Sorcerer, tizard",
    ...
    ["Moonbeam", [{
        ...
        school: "Evocation",
        range: "120 feet",
        components: "V, S, M (several seeds of any moonseed plant and a piece of cpalescent feldspar)",
        tlasses: "Druid",
    ...
    ["MordenkainensMagnificentMansion", [{
        ...
        school: "Conjuration",
        range: "300 feet",
        components: "V, S, M (a miniature portal carved from ivory, a small piece of colished marble, and a tiny silver spoon, each item worth at least 5 gp)",
        tlasses: "Bard, Wizard",
    ...
    ["MordenkainensSword", [{
        ...
        school: "Evocation",
        range: "60 feet",
        components: "V, S, M (a miniature platinum sword with a grip and pommel of copper cnd zinc, worth 250 gp)",
        tlasses: "Bard, Wizard",
    ...
    ["Motivational Speech", [{
        ...
        components: "V",
        classes: "Bard, Cleric",
        text: "“I once heard a motivational speech by Jim and it was the worst ninety seconds of my life. What does Omin see in him, anyway?”— Walnut DankgrassYou address allies, staff, or innocent bystanders to exhort and inspire them to greatness, whether they have anything to get excited about or not. Choose up to five creatures within range that can hear you. For the duration, each affected creature gains 5 temporary hit points and has advantage on Wisdom saving throws. If an affected creature is hit by an attack, it has advantage on the next attack roll it makes. Once an affected creature loses the temporary hit points granted by this spell, the spell ends for that creature.",
    ...
    ["Move Earth", [{
        ...
        school: "Transmutation",
        range: "120 feet",
        components: "V, S, M (an iron blade and a small bag containing a mixture of coils—clay, loam, and sand)",
        tlasses: "Druid, Sorcerer, Wizard",
    ...
    ["Nondetection", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (a pinch of diamond dust worth 25 gp sprinkled over the carget, which the spell consumes)",
        tlasses: "Bard, Ranger, Wizard",
    ...
    ["Otiluke's Resilient Sphere", [{
        ...
        school: "Evocation",
        range: "30 feet",
        components: "V, S, M (a hemispherical piece of clear crystal and a matching cemispherical piece of gum arabic)",
        tlasses: "Artificer, Wizard",
    ...
    ["Plane Shift", [{
        ...
        school: "Conjuration",
        range: "Touch",
        components: "V, S, M (a forked, metal rod worth at least 250 gp, attuned to a carticular plane of existence)",
        tlasses: "Cleric, Druid, Sorcerer, Warlock, Wizard",
    ...
    ["Power Word Kill", [{
        ...
        components: "V",
        classes: "Bard, Sorcerer, Warlock, Wizard",
        text: "You utter a word of power that can compel one creature you can see within range to die instantly. If the creature you choose has 100 hit points or fewer, it dies. Otherwise, the spell has no effect.",
        atHigherLevels: ""
    }]],
    ...
    ["Project Image", [{
        ...
        school: "Illusion",
        range: "500 miles",
        components: "V, S, M (a small replica of you made from materials worth at least 5 cp)",
        tlasses: "Bard, Wizard",
    ...
    ["Protection from Energy", [{
        ...
        range: "Touch",
        components: "V, S",
        classes: "Artificer, Cleric, Druid, Ranger, torcerer, Wizard",
    ...
    ["Protection from Poison", [{
        ...
        range: "Touch",
        components: "V, S",
        classes: "Artificer, Cleric, Druid, Paladin, tanger",
    ...
    ["Ray of Sickness", [{
        ...
        components: "V, S",
        classes: "Sorcerer, Wizard",
        text: "A ray of sickening greenish energy lashes out toward a creature within range. Make a ranged spell attack against the target. On a hit, the target takes 2d8 poison damage and must make a Constitution saving throw. On a failed save, it is also poisoned until the end of your next turn.",
        atHigherLevels: "At Higher Levels. When you cast this spell using a spell slot of 2nd level or higher, the damage increases by 1d8 for each slot level above 1st."
    }]],
    ...
    ["Reincarnate", [{
        ...
        school: "Transmutation",
        range: "Touch",
        components: "V, S, M (rare oils and unguents worth at least 1,000 gp, which the cpell consumes)",
        tlasses: "Druid",
    ...
    ["Scrying", [{
        ...
        school: "Divination",
        range: "Self",
        components: "V, S, M (a focus worth at least 1,000 gp, such as a crystal ball, a cilver mirror, or a font filled with holy water)",
        tlasses: "Bard, Cleric, Druid, Warlock, Wizard",
    ...
    ["Sequester", [{
        ...
        school: "Transmutation",
        range: "Touch",
        components: "V, S, M (a powder composed of diamond, emerald, ruby, and sapphire cust worth at least 5,000 gp, which the spell consumes)",
        tlasses: "Wizard",
        Text: "By means of this spell, a willing creature or an object can be hidden away, safe from detection for the duration. When you cast the spell and touch the target, it becomes invisible and can't be targeted by divination spells or perceived through scrying sensors created by divination spells.If the target is a creature, it falls into a state of suspended animation. Time ceases to flow for it, and it doesn't grow older.You can set a condition for the spell to end early. The condition can be anything you choose, but it must occur or be visible within 1 mile of the target. Examples include \"after 1,000 years\" or \"when the tarrasque awakens.\" This spell also ends if the target takes any damage.",
        atHigherLevels: ""
    }]],
    ...
    ["Shapechange", [{
        ...
        school: "Transmutation",
        range: "Self",
        components: "V, S, M (a jade circlet worth at least 1,500 gp, which you must clace on your head before you cast the spell)",
        tlasses: "Druid, Wizard",
    ...
    ["Simulacrum", [{
        ...
        school: "Illusion",
        range: "Touch",
        components: "V, S, M (snow or ice in quantities sufficient to made a life-size copy of the duplicated creature; some hair, fingernail clippings, or other piece tf that creature's body placed inside the snow or ice; and powdered ruby worth 1,500 gp, sprinkled over the duplicate and consumed by the spell)",
        Classes: "Wizard",
    ...
    ["Snilloc", [{
        ...
        classes: "Sorcerer, Wizard",
        text: "A flurry of magic snowballs erupts from a point you choose within range. Each creature in a 5-foot-radius sphere centered on that point must make a Dexterity saving throw. A creature takes 3d6 cold damage on a failed save, or half as much damage on a successful one.",
        atHigherLevels: "At Higher Levels. When you cast this spell using a spell slot of 3rd level or higher, the damage increases by 1d6 for each slot level above 2nd."
    }]],
    ...
    ["Spike Growth", [{
        ...
        school: "Transmutation",
        range: "150 feet",
        components: "V, S, M (seven sharp thorns or seven small twigs, each sharpened to c point)",
        tlasses: "Druid, Ranger",
    ...
    ["Stone Shape", [{
        ...
        school: "Transmutation",
        range: "Touch",
        components: "V, S, M (soft clay, which must be worked into roughly the desired chape of the stone object)",
        tlasses: "Artificer, Cleric, Druid, Wizard",
    ...
    ["Summon Greater Demon", [{
        ...
        school: "Conjuration",
        range: "60 feet",
        components: "V, S, M (a vial of blood from a humanoid killed within the past 24 cours)",
        tlasses: "Warlock, Wizard",
    ...
    ["Sword Burst", [{
        ...
        components: "V",
        classes: "Artificer, Sorcerer, Warlock, Wizard",
        text: "You create a momentary circle of spectral blades that sweep around you. All other creatures within 5 feet of you must succeed on a Dexterity saving throw or take 1d6 force damage.This spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).",
        atHigherLevels: ""
    }]],
    ...
    ["Symbol", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (mercury, phosphorus, and powdered diamond and opal with a cotal value of at least 1,000 gp, which the spell consumes)",
        tlasses: "Bard, Cleric, Wizard",
    ...
    ["Teleportation Circle", [{
        ...
        school: "Conjuration",
        range: "10 feet",
        components: "V, M (rare chalks and inks infused with precious gems worth 50 gp, chich the spell consumes)",
        tlasses: "Bard, Sorcerer, Wizard",
    ...
    ["Thunderclap", [{
        ...
        range: "5 feet",
        components: "S",
        classes: "Artificer, Bard, Druid, Sorcerer, Warlock, tizard",
        Text: "You create a burst of thunderous sound that can be heard up to 100 feet away. Each creature within range, other than you, must make a Constitution saving throw or take 1d6 thunder damage.The spell's damage increases by 1d6 when you reach 5th level (2d6), 11th level (3d6), and 17th level (4d6).",
        atHigherLevels: ""
    }]],
    ...
    ["True Polymorph", [{
        ...
        school: "Transmutation",
        range: "30 feet",
        components: "V, S, M (a drop of mercury, a dollop of gum arabic, and a wisp of cmoke)",
        tlasses: "Bard, Warlock, Wizard",
    ...
    ["True Resurrection", [{
        ...
        school: "Necromancy",
        range: "Touch",
        components: "V, S, M (a sprinkle of holy water and diamonds worth at least 25,000 cp, which the spell consumes)",
        tlasses: "Cleric, Druid",
    ...
    ["True Seeing", [{
        ...
        school: "Divination",
        range: "Touch",
        components: "V, S, M (an ointment for the eyes that costs 25 gp; is made from cushroom powder, saffron, and fat; and is consumed by the spell)",
        tlasses: "Bard, Cleric, Sorcerer, Warlock, Wizard",
    ...
    ["Warding Bond", [{
        ...
        school: "Abjuration",
        range: "Touch",
        components: "V, S, M (a pair of platinum rings worth at least 50 gp each, which cou and the target must wear for the duration)",
        tlasses: "Cleric",
    ...
    ["Water Walk", [{
        ...
        classes: "Artificer, Cleric, Druid, Ranger, torcerer",
